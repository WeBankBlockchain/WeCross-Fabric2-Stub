...
public class FabricTransaction {
    ...
    private org.hyperledger.fabric.protos.peer.TransactionPackage.Transaction transaction;
    ...
    public static class TransactionAction {
        private org.hyperledger.fabric.protos.peer.TransactionPackage.TransactionAction
                transactionAction;
        ...
        public static class ChaincodeActionPayload {
            private org.hyperledger.fabric.protos.peer.TransactionPackage.ChaincodeActionPayload
            ...
            public static class ProposalPayload {
                private ProposalPackage.ChaincodeProposalPayload chaincodeProposalPayload;
                ...
                public ProposalPayload(byte[] bytes) throws Exception {
                    this.chaincodeProposalPayload =
                            ProposalPackage.ChaincodeProposalPayload.parseFrom(bytes);
